...
| ------- | ------ | ----------------- | ------ | ---------- |
| Зиннурова Диана (@dianissimo_z), <br> Петров Олег, <br> Бордюгов Максим (@DedAzaMarks), <br> Каледин Андрей (@kaledin_andrew) | Крестики-нолики онлайн: REST-сервис + консольный клиент к нему | 02.02 &mdash; Создать репозиторий <br> 11.02 &mdash; Проектная документация | https://github.com/kaledinandrew/TicTacToeOnline | * Проект повышенной трудности <br> * Опыт бэкенд-разработки есть у Максима и Андрея <br> * Web UI не будет, поэтому HTML/CSS/Javascript, к счастью, остаются за бортом |
